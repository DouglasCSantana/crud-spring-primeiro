...
import com.example.demo.config.Connection;
...
public class ProducerHardCodedRepository {
    ...
    public  List<Producer> findyAll() {

        return producerData.getProducers();
    }
    public Optional<Producer> findyById(Long id){
       return producerData.getProducers().stream().filter(producer -> producer.getId().equals(id)).findFirst();
    }
    public List<Producer> findyByName(String name){
